...
if(isset($_POST['submit'])){
   ...
   $sql ="INSERT INTO crud (id, frist_name, last_name, email, gender)
    VALUES (NULL, '$frist_name', '$last_name', '$email', '$gender')";
  ...
  <body>
    ...
    <div class="container">
        <div class="text-center mp-4">
            <h3>Add New User</h3>
            <p class="text-muted">Complete the form bleow to add a new user</p>
         </div>
            ...
            <form action="" method="post" style="width: 50vw; min-width:300px;" >
                <div class="row mp-3">
                    <div class="col">
                        ...
                        <input type="text" class="form-control" name="frist_name" placeholder="Anooos">
                    </div>

                    <div class="col">
                        <label class="form-laple">Last Name:</label>
                        <input type="text" class="form-control" name="last_name" placeholder="Maher">
                    </div>
                 </div>
